...
triad_census_attr <- function(g,vattr){
  ...
  orbit_classes <- matrix(c(0,0,0,2,3,1,2,1,3,11,12,12,3,2,1,5,5,4,6,7,8,14,15,13,
                            ...
                            25,26,26,34,33,32,34,32,33,35,35,35),ncol=3,byrow = T)
  tri_names <- c("003","012","012","021D","012","102","021C","111U","012","021C","021U","030T",
  ...
  triad_names <- c()
  triad_names1 <- c()
  for(i in 1:nrow(orbit_classes)){
    for(j in 1:nrow(attrcomb)){
